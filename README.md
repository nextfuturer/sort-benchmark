...
3. **Test 3 (Âm/Dương xen kẽ sát mức giới hạn):** Sinh các số gần `INT_MIN` và `INT_MAX`. Nhắm vào các bạn dùng Radix Sort nhưng xử lý bit dấu sai hoặc ép kiểu bị tràn bộ đệm.
